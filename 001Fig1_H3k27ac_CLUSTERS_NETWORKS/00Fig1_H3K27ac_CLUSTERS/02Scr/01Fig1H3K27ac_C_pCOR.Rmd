...
## Spearman`s test Correlation between H3K27ac-ChIP-seq vs RNA-seq
```{r,message=FALSE,class.source="bg-info",warning=FALSE}
NAME11d<- data.frame(colnames(MA1u))
##extract name for the histone enrichment
mat_m1b2<- data.frame(NAME11d[grep("H_zRPKMmean*", NAME11d[,1]), ])
...
## Elbow to determine which one is the number of cluster to use from the data.
...
## Script to perform the line plot in Fig1C
...
## 003_FIG1B_01Fig1H3K27ac_C_pCOR_CLUS_LINEs.pdf
