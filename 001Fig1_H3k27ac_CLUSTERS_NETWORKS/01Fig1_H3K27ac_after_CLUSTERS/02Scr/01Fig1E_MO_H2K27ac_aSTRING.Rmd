...
##### To integrates the Protein network from the slected H3K27ac clusters.

## **Input files**
##### C1_113_Proteins_string_interactions_short.tsv
##### C2_34_Proteins_string_interactions_short.tsv		
##### C4_26_Proteins_string_interactions_short.tsv
- these files are the output file from the protein network from String web online tool. We used all the Proteins associated with the enriched DNA motifs with a log10Pvalue>=1

## **Output files**
#### 001_FIG1E_01Fig1E_MO_H2K27ac_aSTRING_HEAT_TOP10.pdf
- Heatmap used in the main figure

#### 001_FIG1E_01Fig1E_MO_H2K27ac_aSTRING_SUPLE.pdf
...
```{r,echo=FALSE,message=FALSE,class.source="bg-info",warning=FALSE}
SI=10
XL="Protein Motifs"
...
write.table(MA7_25_TOP10_2,file=paste(PORT2, PROJECT,"_",NAME_G2[2,3],"_",CY,".txt", sep=""),sep="\t",row.names = F,col.names=T,dec=".",quote = F)
write.table(MA7_25_TOP10_3,file=paste(PORT2, PROJECT,"_",NAME_G2[3,3],"_",CY,".txt", sep=""),sep="\t",row.names = F,col.names=T,dec=".",quote = F)
