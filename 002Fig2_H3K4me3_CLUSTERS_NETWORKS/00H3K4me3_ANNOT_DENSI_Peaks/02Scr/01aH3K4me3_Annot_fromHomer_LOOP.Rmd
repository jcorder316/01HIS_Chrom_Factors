...
# **Objective**
- To provide a summary annotation to a ChIP-seq peak file.

# General Comments on the Script

-Many ChIP-seq annotation programs provide details information on the genomic areas where the peaks are located in the genome. Although, this an important information, sometimes makes it hard to handle plot legends into the figure of a paper. Therefore, in this script we summarize the annotated genomic areas in 3 main areas **Promoter= TSS+/- 2kb, Genomic (>2kb), and Intergenic**. We used the output results from Homer **annotatepeaks.pl**, with a gtf file merged from different databases of Zebrafish. The script could be highly customized and modified to the research question.
