...
# **Objective**
- To integrate Protein network from the selected H3K4me3 clusters.

# General Comments on the Script
- Usually, a lot of Transcriptional factors **TFs** are found to be associated with the Peaks areas, in this Script we handle STRING database results to find the Top TFs associated with the Histone marks. The filtering is performed by counting which TFs have the highest number of known proteins interacting with the TFs.
...
# Subset the Top 10 of TFs from the STRING results
