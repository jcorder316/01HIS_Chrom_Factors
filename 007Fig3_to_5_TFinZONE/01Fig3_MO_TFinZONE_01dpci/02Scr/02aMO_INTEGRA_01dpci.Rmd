...
# **Objectives**
- To combine all DNA motifs into one matrix to be used in Transcriptional Factor in the neighborhood Zone (TFinZONE) at 01dcpi as a reference point.<br />
...
library(knitr)
knitr::include_graphics("./heatmap_01dcpi.png")
```
