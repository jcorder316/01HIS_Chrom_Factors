...
# **Objectives**
- To find the Transcription Factor in the neighborhood Zone (TFinZONE) at 04dcpi as a reference point.<br />
...
library(knitr)
knitr::include_graphics("./inZONE_04dcpi.png")
```
...
#NAME_G2$GROUP <- gsub("CORR1_04d_", "", NAME_G2$ENH4)
...
#AC_RE_VOL_SC$GROUP <- gsub("CORR1_04d_", "", AC_RE_VOL_SC$GROUP)
...
#AC_RE_VOL_SC_META$GROUP2 <- gsub("CORR1_04d_u_", "", AC_RE_VOL_SC_META$GROUP)
