...
##### To generate bar plot from the broadness of the H3K4me3 ChIP-seq.
...
## **Output files**
    #### 001_FIG_2B_S2B_02aH3K4me3_PEAK_BROADNESS.pdf
        - Bar plot from the broadness of the peak separated by genomic regions.

#### 002_FIG2D_02aH3K4me3_PEAK_BROADNESS_W_PVALUEs.pdf
        - Boxplot from the gene expression by peak broadness

#### 02aH3K4me3_PEAK_BROADNESSPEAK_fromR2.txt
        - Annotated peak file from the bar plot.
#### 003_FIGS2C_02aH3K4me3_PEAK_BROADNESS_W_P_x_GE_AREA.pdf
        - Boxplot from the gene expression by peak broadness separated by genomic region

#### 004_SUPL_02aH3K4me3_PEAK_BROADNESS_BOX_GENO_PEAK_SIZE_W_PVALUEs.pdf
...
TSS_EMS="../01DATA/001Emsem_danRer11_TSS2kb_Annot.bed"
...
########### load biomart
RES="../01DATA/002PEAKS_ALL_ANNOT_EM_REF_NON.txt"
...
PEAKS="../../01CLUS_H3K4me3/01DATA/01ANNO_PEAKS_H3K4me3_ZF_ALL_x_BEDTO.bed"
...
######  Crossed with RNA-seq #########
```{r,class.source="bg-info",echo=TRUE,warning=FALSE}
meta = "../../01CLUS_H3K4me3/01DATA/02RE_analysis_PRJNA509429_CLUS.csv"
...
### To check one peak annotated files from H3K4me3 ChIP-seq
```{r,class.source="bg-info",echo=TRUE,warning=FALSE}
file.list0 <- list.files(path=WORK,pattern='*.broadPea_annot_EM_REF_NON', all.files = T,   full.names = T, recursive = T)
...
#### To prepare for the Barplot for the broadness ######
...
```
##### Box expression plot with and without P-value
```{r,message=FALSE,class.source="bg-info",warning=FALSE,echo=FALSE}
MAX=4.4
...
pdf(file=paste(PTHA,"003_FIGS2C_", PROJECT,"_W_P_x_GE_AREA.pdf",sep=""),width=5, height=5 )
...
pdf(file=paste(PTHA,"004_SUPL_",PROJECT,"_BOX_GENO_PEAK_SIZE_W_PVALUEs",".pdf", sep=""),width=7, height=5)  
